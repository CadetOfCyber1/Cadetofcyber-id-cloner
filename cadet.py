#Script Given By Cadet Of Cyber
#Script Is Given For Educational Purpose
#Script Edited By Fahim
#Utf-8 python 
...
\033[1;92m\              
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Cadet Of Cyber
\033[1;92mFb \033[1;93m: Jmr Fahim
...
def main():
    ...
    print ' \033[0m[3].\x1b[1;96m New Channel Go & Subscribe '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://youtube.com/channel/UCi6m5MLMZOnabXr3OpwiQ4A')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
